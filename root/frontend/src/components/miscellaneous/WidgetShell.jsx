function WidgetShell({ number, eyebrow, title, status, indicators, children, className = "", ...rest }) {
    return (
        <article 
            className={`flex flex-col justify-between min-h-[280px] md:h-98.75 rounded-2xl border border-[#9eaedb]/16 bg-linear-to-br from-[#11172a]/78 to-[#0d111f]/52 p-6 shadow-[0_1.5rem_4rem_rgba(0,0,0,0.16)] overflow-hidden ${className}`}
            {...rest}
        >
